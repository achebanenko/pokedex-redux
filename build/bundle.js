...
var _pokemons = __webpack_require__(59);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.renderType = _this.renderType.bind(_this);
    _this.toggleCart = _this.toggleCart.bind(_this);
  ...
  _createClass(App, [{
    ...
    value: function handleClick(event) {
      var lis = document.querySelectorAll('.typeList li');
    ...
    value: function renderType(type) {
      return _react2.default.createElement(
        'li',
        { key: type, className: '' + (this.state.filterType === type ? type + ' selected' : ''), onClick: this.handleClick },
        type
      );
    }
  }, {
    ...
    value: function addToCart(id) {
      var pokemon = this.state.pokemons.find(function (pokemon) {
      ...
      */
      ...
      var itemIndex = this.state.cart.findIndex(function (item) {
        return item.id === id;
      });

      if (itemIndex === -1) {
        var cart = [].concat(_toConsumableArray(this.state.cart), [pokemon]);
    ...
    value: function removeFromCart(id) {
      ...
      // const cart = this.state.cart.filter((_,i) => i !== itemIndex);
      ...
      */
      ...
      if (itemIndex !== -1) {
        var cart = [].concat(_toConsumableArray(this.state.cart.slice(0, itemIndex)), _toConsumableArray(this.state.cart.slice(itemIndex + 1)));
        this.setState({ cart: cart });
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var types = ['any', 'normal', 'electric', 'fire', 'water', 'grass', 'bug', 'fight', 'psychic', 'fairy', 'flying'];

      var filteredPokemons = this.state.pokemons.filter(function (pokemon) {
        return pokemon.name.toLowerCase().includes(_this2.state.filterText.toLowerCase());
      });
      if (this.state.filterType !== 'any') filteredPokemons = filteredPokemons.filter(function (pokemon) {
        return pokemon.type.indexOf(_this2.state.filterType) > -1;
      });

      return _react2.default.createElement(
        'div',
        { className: 'wrapper' },
        _react2.default.createElement(_Header2.default, { cartCount: this.state.cart.length, toggleCart: this.toggleCart }),
        _react2.default.createElement(
          'div',
          { className: 'filterInput' },
          _react2.default.createElement('input', { onChange: this.handleChange, placeholder: 'Gotta Catch\'em all' })
        ),
        _react2.default.createElement(
          'ul',
          { className: 'typeList' },
        ...
        filteredPokemons.length > 0 ? _react2.default.createElement(_List2.default, { pokemons: filteredPokemons, cart: this.state.cart, addToCart: this.addToCart }) : _react2.default.createElement(
          'div',
        ...
        _react2.default.createElement(_Cart2.default, { cart: this.state.cart, toggleCart: this.toggleCart, removeFromCart: this.removeFromCart })
      );
    }
  }]);
	...
	_createClass(Header, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'cartBtn', onClick: this.props.toggleCart },
					_react2.default.createElement(
						'div',
						{ className: 'cartItemCount' },
						this.props.cartCount
					),
					_react2.default.createElement('img', { src: 'img/shopping-cart.svg', alt: '' })
				)
			);
		}
	}]);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				pokemons.map(function (pokemon) {
					var inCart = _this2.props.cart.some(function (item) {
						return item.name === pokemon.name;
					});

					return _react2.default.createElement(_Item2.default, { key: pokemon.id, details: pokemon, addToCart: _this2.props.addToCart, inCart: inCart });
				})
			);
		}
	}]);
...
var Item = function (_React$Component) {
	...
	_createClass(Item, [{
		...
		value: function render() {
			...
			var pokemon = this.props.details;
			...
			return _react2.default.createElement(
				'div',
				{ className: '' + (this.props.inCart ? 'listItem listItem--added' : 'listItem'), key: pokemon.id },
				...
				_react2.default.createElement(
					'div',
					{ className: 'listItem__addButton', onClick: function onClick() {
							return _this2.props.addToCart(pokemon.id);
						} },
...
var Cart = function (_React$Component) {
	...
	_createClass(Cart, [{
		...
		value: function renderItem(item) {
			...
			return _react2.default.createElement(
				"div",
				{ className: "cartListItem", key: item.id },
				_react2.default.createElement(
					"div",
					{ className: "cartListItem__removeBtn", onClick: function onClick() {
							return _this2.props.removeFromCart(item.id);
						} },
					_react2.default.createElement("img", { src: "img/error.svg" })
				),
				_react2.default.createElement("img", { className: "cartListItem__image", src: item.image, alt: item.name, title: item.name })
			);
		}
	}, {
		key: "render",
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					"div",
					{ className: "cartCloseBtn", onClick: this.props.toggleCart },
					"Close"
				),
				this.props.cart.length > 0 ? _react2.default.createElement(
					"div",
					{ className: "cartList" },
					this.props.cart.map(this.renderItem)
				) : false,
				this.props.cart.length === 0 ? _react2.default.createElement(
					"div",
					{ className: "cartEmpty" },
